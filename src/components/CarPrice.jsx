    ...
    <div className="bg-white p-4 sm:p-6">
        ...
        <div className="flex items-center gap-2 mb-2">
          <div className="flex items-center">
            {[...Array(5)].map((_, i) => (
              <svg
                key={i}
                className={`w-4 h-4 sm:w-5 sm:h-5 ${i < 4 ? 'text-orange-500' : 'text-gray-300'}`}
                fill="currentColor"
                viewBox="0 0 20 20"
              >
          ...
          <span className="text-orange-500 font-semibold text-sm sm:text-base">4.5</span>
          <span className="text-red-500 text-xs sm:text-sm">2 Reviews</span>
        </div>

        {/* Car Price */}
        <div className="mb-4">
          <h3 className="text-base sm:text-lg font-semibold text-gray-800 mb-2">Car Price</h3>
          <div className="flex flex-col sm:flex-row sm:items-baseline gap-2 sm:gap-3">
            <span className="text-2xl sm:text-3xl font-bold text-gray-800">US$ 540</span>
            <div className="flex items-center gap-2">
              <span className="bg-red-500 text-white px-2 py-1 text-xs font-semibold rounded">
                13% OFF
              </span>
              <div className="flex flex-col">
                <span className="text-base sm:text-lg text-gray-500 line-through">US$ 620</span>
                <span className="text-xs sm:text-sm text-red-500">Save US$ 80</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="mb-6">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h3 className="text-base sm:text-lg font-semibold text-gray-800">Total Price Calculator</h3>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 mb-4">
          ...
          <div>
            <label className="block text-xs sm:text-sm font-medium text-gray-700 mb-1">Port</label>
            <select className="w-full p-2 text-sm border border-gray-300 rounded-md focus:ring-2 focus:ring-red-500 focus:border-red-500">
        ...
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
          <label className="flex items-center">
            ...
            />
            <span className="text-xs sm:text-sm text-gray-700">Inspection</span>
          </label>
          <label className="flex items-center">
            <input
              type="checkbox"
              ...
              className="mr-2 text-red-500 focus:ring-red-500"
            />
            <span className="text-xs sm:text-sm text-gray-700">Insurance</span>
          </label>
        </div>
      </div>
      ...
      <div className="mb-6">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-base sm:text-lg font-semibold text-gray-800">Free Quote / Inquiry</h3>
          </div>
            ...
            <Form className="space-y-3 sm:space-y-4">
              <div>
                ...
                <Field
                  ...
                  className={`w-full p-2 text-sm border rounded-md focus:ring-2 focus:ring-red-500 focus:border-red-500 ${
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                ...
                <div>
                  <label className="block text-xs sm:text-sm font-medium text-gray-700 mb-1">Phone2</label>
                  <Field
                    type="tel"
                    name="phone2"
      ...
      <div className="mb-6 p-3 sm:p-4 bg-gray-50 rounded-lg">
        <div className="text-xs sm:text-sm text-gray-600 mb-1">C&F LONG BEACH</div>
        <div className="flex items-center justify-between">
          <span className="text-base sm:text-lg font-semibold text-gray-800">Total Price</span>
          <span className="text-xl sm:text-2xl font-bold text-red-500">US$ 2,084</span>
        </div>
      </div>
        ...
        {({ errors, touched, isSubmitting, isValid, dirty, submitForm, values, setFieldError, validateForm }) => (
          <div className="space-y-3 mb-6">
            <button 
              ...
              className={`w-full font-semibold py-3 px-4 rounded-lg flex items-center justify-center gap-2 transition-colors duration-200 text-sm sm:text-base ${
            ...
            <button 
              ...
              className={`w-full border-2 font-semibold py-3 px-4 rounded-lg flex items-center justify-center gap-2 transition-colors duration-200 text-sm sm:text-base ${
                !isValid || !dirty || isSubmitting
      ...
      {/* Share Section */}
      <div>
        <h4 className="text-xs sm:text-sm font-semibold text-gray-800 mb-3">Share</h4>
        <div className="flex gap-2 sm:gap-3">
          <button className="w-8 h-8 sm:w-10 sm:h-10 bg-green-500 hover:bg-green-600 rounded-full flex items-center justify-center transition-colors duration-200">
          ...
          <button className="w-8 h-8 sm:w-10 sm:h-10 bg-sky-400 hover:bg-sky-500 rounded-full flex items-center justify-center transition-colors duration-200">
            <svg className="w-4 h-4 sm:w-5 sm:h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
