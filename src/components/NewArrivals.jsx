      ...
      <div className=" mx-auto px-6">
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center space-x-4">
            {/* <div className="bg-[#D7061F] text-white px-3 py-1 rounded font-bold text-sm">
              New
            </div> */}
            <div className="bg-[#D7061F]  text-[10.15px] leading-[13.54px] text-white px-3 py-1  rounded-sm">
              New
            </div>
            <h2 className="font-roboto font-bold text-[20.31px] leading-[27.08px] align-middle text-gray-800">New Arrivals</h2>
          </div>
